...
{
	$result = "";
	if ( ! wg_check_input_string( $src, 1, 32 ) )
	{
		return false;
	}
	$result = $src;
...
function wg_check_input_string_ank( $value, $min, $max )
{
	...
	return wg_check_input_string( $value, $min, $max );
}
...
function wg_check_input_email( $mailadr )
{
	...
	if ( wg_check_input_string( $mailadr, 3, 1024 ) == false )
	{
		return false;
	}
